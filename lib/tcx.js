...
(function() {
  ...
  Parser = (function() {
    ...
    function Parser(opts) {
      ...
      this.parse_xml = bind(this.parse_xml, this);
        ...
        return function(name) {
          ...
          switch (p) {
            ...
            case "Activities|Activity|Lap|TriggerMethod":
              x = 0;
              break;
            case "Activities|Activity|Lap|Track|Trackpoint|Extensions|ns3:TPX|ns3:Watts":
              _this.curr_tkpt.watts = parseInt(_this.curr_text);
              break;
            case "Activities|Activity|Lap|Track|Trackpoint|Extensions|ns3:TPX|ns3:Speed":
              _this.curr_tkpt.speed = parseFloat(_this.curr_text);
              break;
    ...
    Parser.prototype.parse_xml = function(xml_str) {
      return this.parser.parse(xml_str);
    };
